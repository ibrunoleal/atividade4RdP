...
public class GraficoDePontos extends JFrame {
	/**
	 * 
	 */
	...
	public GraficoDePontos(String tituloDaAplicacao, String tituloDoGrafico) {
	...
	private JFreeChart createChart(XYDataset dataset, String labelX, String labelY) {
		...
		JFreeChart chart = ChartFactory.createScatterPlot(tituloDoGrafico,// chart title
				labelX, // x axis label
				labelY, // y axis label
				dataset, // data
